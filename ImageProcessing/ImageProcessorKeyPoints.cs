...
{
    public class ImageProcessorKeyPoints : IImageProcessor
    {
        static string ynnModelPath = @"D:\Data\Projects\ISA 2.0\ISA 2\Resources\face_detection_yunet_2023mar.onnx";
        FaceDetectorYN model;

        public ImageProcessorKeyPoints(int videoCaptureWidth, int videoCaptureHeight)
        {
        ...
        {
            return MathF.Abs(faceElements[4] - faceElements[6]);
